	...
	<div class="timeline-layout">
		...
		<div class="timeline-layout__title">
			<div class="timeline-table">
				...
				<div class="timeline-table__timeline timeline-table__timeline--relative">
					<div class="timeline-container">
						<?php for ($x = 0; $x <= 20; $x++) { ?>
						<div class="timeline-rule">
							<div class="timeline-rule__text"><?php echo($x*100); ?></div>
							<div class="timeline-rule__hatch timeline-rule__hatch--1"></div>
							<div class="timeline-rule__hatch timeline-rule__hatch--2"></div>
							<div class="timeline-rule__hatch timeline-rule__hatch--3"></div>
							<div class="timeline-rule__hatch timeline-rule__hatch--4"></div>
							<div class="timeline-rule__hatch timeline-rule__hatch--5"></div>
							<div class="timeline-rule__hatch timeline-rule__hatch--6"></div>
							<div class="timeline-rule__hatch timeline-rule__hatch--7"></div>
							<div class="timeline-rule__hatch timeline-rule__hatch--8"></div>
							<div class="timeline-rule__hatch timeline-rule__hatch--9"></div>
						</div>
						<?php } ?>
					</div>
				</div>
		...
		<!-- content -->
		<div class="timeline-layout__content">
			<div class="timeline-table">

				<!-- layers column -->
				<div class="timeline-table__layers">
					<div class="layer-svg">&lt;svg id="raygun-artboard"&gt;</div>
					<div class="layer">
